...
export default function HargaPaketBelajar() {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 justify-center gap-6 mt-12 md:mt-8 w-[85%] md:w-[70%] xl mx-auto">
      {paketBelajar.map((paket, index) => {
        return (
          <div className="relative mx-auto" key={index}>
            ...
            <div className="h-[6.8rem] sm:h-[8.4rem] xl:h-[9.6rem] text-center pt-[1.8rem] sm:pt-[2.6rem] rounded-lg mb-8 px-2 bg-[#f5f5f5]">
